                ...
                <footer className="py-6 text-center border-t border-white/10">
                    <div className="container mx-auto px-4">
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                            <div>
                                <h3 className="text-lg font-medium mb-4">Adyant & his team</h3>
                                <p className="text-white/80">
                                    Kids create, oceans breathe. Making waves with creative designs.
                                </p>
                            </div>
                            <div>
                                ...
                                <ul className="space-y-2">
                                    <li>
                                        <a href="/art" className="text-white/80 hover:text-white">
                                            Art Gallery
                                        </a>
                                    </li>
                                    <li>
                        ...
                        <div className="mt-8 pt-8 border-t border-white/10 text-center text-white/60">
                            <p>&copy; {new Date().getFullYear()} Adyant & his team. All rights reserved.</p>
                        </div>
                    </div>
                </footer>
                <CookieConsent />
